========================================================================
    APLICACIÓN DE CONSOLA: ENCARA2_2libDemo_console 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ENCARA2_2libDemo_console.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación ENCARA2_2libDemo_console.


ENCARA2_2libDemo_console.vcxproj
...
ENCARA2_2libDemo_console.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado ENCARA2_2libDemo_console.pch y un archivo de tipos 
