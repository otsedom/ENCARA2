================================================================================
    ...
    proyectoENCARA2_2libDemo
================================================================================

El Asistente para aplicaciones ha creado esta aplicación ENCARA2_2libDemo.
...
constituyen su aplicación ENCARA2_2libDemo.

ENCARA2_2libDemo.vcxproj
...
ENCARA2_2libDemo.vcxproj.filters
...
ENCARA2_2libDemoDoc.h, ENCARA2_2libDemoDoc.cpp – el documento
    Estos archivos contienen su clase CENCARA2_2libDemoDoc. Edite estos archivos 
    para agregar los datos del documento especial y para guardar y cargar el 
    archivo (mediante CENCARA2_2libDemoDoc::Serialize).

ENCARA2_2libDemoView.h, ENCARA2_2libDemoView.cpp – la vista del documento
    Estos archivos contienen su clase CENCARA2_2libDemoView.
    Los objetos CENCARA2_2libDemoView se utilizan para ver objetos 
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado ENCARA2_2libDemo.pch y un archivo de 
