...
// ENCARA2_2libDemo.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CENCARA2_2libDemoApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CENCARA2_2libDemoApp::OnAppAbout)
...
// Construcción de CENCARA2_2libDemoApp

CENCARA2_2libDemoApp::CENCARA2_2libDemoApp()
{
	...
	SetAppID(_T("ENCARA2_2libDemo.AppID.NoVersion"));

	// TODO: agregar aquí el código de construcción,
	// Colocar toda la inicialización importante en InitInstance
}

// El único objeto CENCARA2_2libDemoApp

CENCARA2_2libDemoApp theApp;


// Inicialización de CENCARA2_2libDemoApp

BOOL CENCARA2_2libDemoApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CENCARA2_2libDemoDoc),
		RUNTIME_CLASS(CMainFrame),       // Ventana de marco SDI principal
		RUNTIME_CLASS(CENCARA2_2libDemoView));
	if (!pDocTemplate)
		return FALSE;
...
int CENCARA2_2libDemoApp::ExitInstance()
{
...
// Controladores de mensaje de CENCARA2_2libDemoApp
...
void CENCARA2_2libDemoApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Métodos para cargar o guardar personalizaciones de  CENCARA2_2libDemoApp

void CENCARA2_2libDemoApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CENCARA2_2libDemoApp::LoadCustomState()
{
}

void CENCARA2_2libDemoApp::SaveCustomState()
{
}
